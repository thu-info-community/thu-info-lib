...
export class InfoHelper {
     ...
     * @param fieldToken    a string representing the token of the field, used when making reservations and paying
    ...
    public makeSportsReservation = async (
        ...
        captcha: string,
        fieldToken: string,
    ) => makeSportsReservation(this, totalCost, phone, receiptTitle, gymId, itemId, date, captcha, fieldToken);
